...
class LocustRunner(object):
    ...
    def choose_method(self, methods):
        global choose_tasks
        choose_tasks = methods 
#        start_method = methods.split()
#        for locust in self.locust_classes:
#            all_tasks.extend(locust.task_set.tasks)
...
#                if value.__name__ in start_method:
#                    tasks.append(value)
#                else:
#                    pass
#            locust.task_set.tasks = tasks

    def filter_method(self):
        global choose_tasks
        tasks = []
        global all_tasks
        start_method = choose_tasks.split()
        for locust in self.locust_classes:
            all_tasks.extend(locust.task_set.tasks)
